...
With the set of logic gates built in project01, use HDL to build gate logic designs that represent numbers and perform arithmetic, ending with a fully functional ALU.

******************************
Tools Used: HardwareSimulator

The goal of this project is to implement all the chips presented in the chapter using the chips that you gradually build and the chips described in project01.  Chip Xxx is implemented with file Xxx.hdl
...
So:
\Chips - permanent home for the Xxx.hdl chip designs that must be implemented for project02
